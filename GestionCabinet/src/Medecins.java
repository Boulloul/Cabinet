...
public class Medecins extends JFrame {
	...
	public void updateTable() {
		table.setModel(DbUtils.resultSetToTableModel(CDAO.getMedecin()));
	}
	...
	public Medecins() {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				String sql="select * from medecins where ID='" +id+"'";
		...
		btnSupprimer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				int ligne = table.getSelectedRow();
				String id =table.getModel().getValueAt(ligne, 0).toString();
				CDAO.DeleteMedecin(Integer.parseInt(id));
				updateTable();
				Clear();
			}
		});
		...
		btnModifier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				int ligne = table.getSelectedRow();
				String id =table.getModel().getValueAt(ligne, 0).toString();
				MedecinModel c = new MedecinModel(Integer.parseInt(textID.getText()), Integer.parseInt(textVersion.getText()), textTitre.getText(), textNom.getText(), textPrenom.getText());
				CDAO.UpdateMedecin(c);
				updateTable();
				Clear();
		...
		lblGestionClient = new JLabel("Gestion Medecins :");
